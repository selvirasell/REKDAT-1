...
def _delvewheel_patch_1_7_0():
    ...
    if sys.version_info[:2] >= (3, 8) and not is_conda_cpython or sys.version_info[:2] >= (3, 10):
        ...
        load_order_filepath = os.path.join(libs_dir, '.load-order-google_re2-1.1.20240702')
        if os.path.isfile(load_order_filepath):
            with open(os.path.join(libs_dir, '.load-order-google_re2-1.1.20240702')) as file:
